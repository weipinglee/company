<section id="content">
    <div class="camera-wrapper">
        <div id="camera" class="camera-wrap">
            <div data-src="{root:main/images/index_slide01.jpg}">

            </div>
            <div data-src="{root:main/images/images/index_slide02.jpg}">

            </div>
            <div data-src="{root:main/images/images/index_slide03.jpg}">
            ...
            <div class="row">
                <div class="grid_4">
                    <div class="box_2 maxheight2 box_inner">
                        <div><img src="images/text.jpg" alt="Image 1"/></div>
                        <div class="caption">
                            <h3 class="text_2">
                                高管解决方案
                            </h3>
                            <p class="text_3">
                                管理团队在企业中担任重要职务，负责经营管理，是企业核心资产
                            </p>
                            <a href="#" class="btn_2 put-right">去看看</a>
                        </div>
