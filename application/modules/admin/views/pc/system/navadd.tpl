...
<h3><a href="{url:admin/system/navList}" class="actionBtn">返回列表</a>自定义导航栏</h3>
    ...
    <div class="idTabs">
      <ul class="tab">
        <li><a href="#nav_add">站内导航</a></li>
        <li><a href="#nav_defined">自定义导航</a></li>
      </ul>
         ...
         <form action="{url:admin/system/doNavAdd}" method="post">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
           ...
           <tr>
            ...
            <td>
             <label for="type_0">
              <input type="radio" name="type" id="type_0" value="middle" checked="true" onChange="getNav(this)">
              主导航</label>
             <label for="type_1">
              <input type="radio" name="type" id="type_1" value="top" onChange="getNav(this)">
             顶部导航</label>
             <label for="type_2">
              <input type="radio" name="type" id="type_2" value="bottom" onChange="getNav(this)">
              底部导航</label>
            </td>
           </tr>
           <tr>
