...
<h3><a href="{url:admin/product/cateList}" class="actionBtn">返回列表</a>编辑分类</h3>

<div class="idTabs">

    <div class="items">
        <div id="nav_add">
            <form action="{url:admin/product/cateAdd}" method="post" auto_submit redirect_url="{url:admin/product/cateList}">
